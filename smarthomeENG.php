                    ...
                    <div class="row pt-5">
                        ...
                        <div class="col-10 my-auto">
                            <p class="text1 my-auto py-3">
                                ...
                                meters,
                                thermostats, water or gas sensors). This greatly increasing detection accuracy </p>
                        </div>
                        <div class="col-2 my-auto">
                    ...
                    <div class="row ">
                        <div class="col-sm-11 h-auto m-auto">
                            <p class="text1">
                                ...
                                The speed or time of the button press doesn't affect the system. <br> Their main advantages are: <br>
                            </p>
                        </div>
                        <div class="col-2 my-auto">
                    ...
                    <div class="col-9 p-0 mb-0 mt-5">
                        <p class="align-text-bottom">
                            When the security system is connected to an intelligent building all <strong> smart
                                ...
                                become a part of it </strong> (door/windows sensors, light switches, power usage
                            meters,
                            thermostats, water or gas sensors). This greatly detection accuracy </p>
                    </div>
                    <div class="col-2 my-auto">
                                ...
                                <div class="col-9">
                                    <p class="m-text1">
                                        Corridors and bathrooms rooms are only dimly lit unless <strong>sensors detect
                                            movement</strong>.
                                        During the day they set themselves to a default mode. In unused rooms they go
                                        back to power saving, decoration or off mode. </p>
                                </div>
                            </div>
                            <div class="row align-items-center ">
                                <div class="col-3 ">
                            ...
                            <div class="row align-items-center ">
                                ...
                                <div class="col-9">
                                    <p class="m-text1">
                                        ...
                                        all the <strong>thermostats switch into low power mode</strong> . And if needed
                                        it
                                        can be turned back on through the Tuya app .                                    </p>
                                </div>
                            </div>
                            <div class="row align-items-center">
                                <div class="col-3 ">
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-9">
                                    <p class="text1">
                                        ...
                                        the light switches. Connecting their inputs
                                        to the switch allows the user to control them with the mechanical switch while
                                        still working through the Tuya app and the kinetic switches </p>
                                </div>
                                <div class="col-3 ">
                                    <img src="./resources/img/golden-dualswitch.png" class="w-100" alt="">
                                </div>
                                <div class="col-9">
                                    <p class="text1">
                                        The system <strong>can be expanded with kinetic switches</strong> if needed.
                                        They can be easily
                                        moved and even mounted on glass if need </p>
                                </div>
                                <div class="col-3 ">
                                    <img src=" ./resources/img/camera.png" class="w-100" alt="">
                                </div>
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-9">
                                    <p class="m-text1">
                                        To <strong>prevent freezing in vacation houses</strong> during the winter
                                        connecting an electric
                                        heater to a Videosec wall plug with a built in thermostat is recommended. </p>
                                </div>
                                <div class="col-3 ">
                                    <img src=" ./resources/img/door-sensor.png" class="w-100" alt="">
                                </div>
