                    ...
                    <div class="row pt-5">
                        <div class="col-sm-11 h-auto m-auto">
                            <p class="text1 py-3">
                                ...
                                aktuátorok, illetve redőnyvezérlők. </p>
                        </div>
                        <div class="col-2 my-auto">
                        ...
                        <div class="col-10 my-auto">
                            <p class="text1 my-auto py-3">
                                ...
                                távvezérelhetővé és automatizálhatóvá teszi az aktuátorokat. </p>
                        </div>
                    </div>
                </div>
            </section>
                    ...
                    <div class="row ">
                        <div class="col-sm-11 h-auto m-auto">
                            <p class="text1">
                                ...
                                megnyomásának sebessége és ideje nem befolyásolja a működést.&nbsp; <br> Alkalmazásuk a következő előnyökkel jár: <br>
                            </p>
                        </div>
                        <div class="col-2 my-auto">
            ...
            <div class="">
                <div class="row ">
                    ...
                    <div class="col-12  text-center">
                        <a href="#smarthome" class="mt-5"><img style="width: 98%;" src="./resources/img/cover-icon.png" alt=""></a>
                    </div>
                </div>
            </div>
        </section>
