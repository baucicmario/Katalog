                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <span class=\"tracking-in-expand\"
                                                    style=\"margin-bottom: 5vw; font-size: 7vw;\">home</span>
                                            </td>
                                        </tr>
                                    </table>
                                </div>
                    ...
                    <div class=\"col-12 vh-100\">
                        ...
                        <div class=\"row\">
                            <div class=\"col-12 mx-5 mt-0 px-5 pb-5 mb-2\">
                                <p class=\"text1\">
                                    An intelligent building is capable of more than just direct user control.
                                    The building instantly <strong>completes tasks by itself</strong> if the correct
                                    requirements are
                                    met.
                                </p>
                                <p class=\"text1\">
                                ...
                                <p class=\"text1\">
                                    The system can <strong>easily be installed</strong> into any home or building be it
                                    new or old.<br>
                                </p>
                                <p class=\"text1\">
                    ...
                    <div class=\"row align-items-center\">
                        <div class=\"col-sm-11 h-auto m-auto\">
                            <p class=\"text1 my-auto py-3\">
                                The alarm output of the Videosec <strong>IQ cameras can be connected</strong> to an
                                inteligent
                                building control system. This allows it <strong>to start automations</strong> based on
                                camera
                                detections. It gives an option to control lighting opening/closing and moving tasks
                                based on:
                            </p>
                        </div>
            ...
            <section class=\" section3\">
                <div class=\"  align-items-center\">
                    ...
                    <div class=\"row \">
                        ...
                        <div class=\"col-10 my-auto\">
                            <p class=\"text1 my-auto py-3\">
                                Decreasing or turning off all lighting or climate control when the security system is
                                armed.
                            </p>
                        </div>
                        <div class=\"col-2 my-auto\">
                        ...
                        <div class=\"col-sm-11 h-auto m-auto\">
                            <p class=\"text1 my-auto py-3\">
                                ...
                                <strong>lower
                                    chance for human error</strong> . It's also capable of full or partial integration
                                with existing
                                outside systems.
                            </p>
                        </div>
            ...
            <section class=\" section5\">
                <div class=\"  align-items-center\">
                    ...
                    <div class=\"row pt-5\">
                        ...
                        <div class=\"col-10 my-auto\">
                            <p class=\"text1 my-auto py-3\">
                                When the security system is connected to an intelligent building all <strong> smart
                                    components
                                    become a part of it </strong> (door/windows sensors, light switches, power usage
                                meters,
                                thermostats, water or gas sensors). This greatly increasing detection accuracy
                        ...
                        <div class=\"col-10 my-auto\">
                            <p class=\"text1 my-auto py-3\">
                                The user can be <strong>notified if they forgot to close a window</strong> or left an
                                appliance on when
                                they try to arm the system.
                            </p>
                        </div>
                        <div class=\"col-2 my-auto\">
                        ...
                        <div class=\"col-10 my-auto\">
                            <p class=\"text1 my-auto py-3\">
                                ...
                                <strong>custom notification</strong> to multiple users simultaneously. The system can
                                notify local
                                authorities in case of emergencies and optionally can be set to be a silent alarm.
                            </p>
                        </div>
                        <div class=\"col-2 my-auto\">
                        ...
                        <div class=\"col-10 my-auto\">
                            <p class=\"text1 my-auto py-3\">
                                Aside from traditional means the system can scare off intruders by switching lights
                                on and off, moving blinds and using other smart appliances.
                            </p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class=\"col-sm-11 h-auto m-auto\">
                            <p class=\"text1 py-3\">
                                Controllers (or actuators) that receive signals from the switches, and are <strong>available
                                    in a
                                    variety of sizes</strong>. we offer dry contact, switch if phase output switches or
                                roller
                                shutters.
                        ...
                        <div class=\"col-10 my-auto\">
                            <p class=\"text1 my-auto py-3\">
                                KRC Controllers are available from 1 to 6 manageable channels and <strong>can be
                                    mounted</strong> to
                                DIN-rails, size 86 wiring boxes or even <strong>behind wall mounted switches</strong>.
                            </p>
                        </div>
                        <div class=\"col-2 my-auto\">
            ...
            <section class=\" section7\">
                <div class=\" align-items-center\">
                    ...
                    <div class=\"row pt-5\">
                        <div class=\"col-sm-11 h-auto m-auto\">
                            <p class=\"text1 my-auto py-3\">
                                All Videosec smart components can be controlled through the <strong>Tuya</strong>
                                ecosystem. The
                                application lets It's users arrange all smart components into rooms and homes. The
                                status of all <strong>components can be monitored and controlled</strong> on the go. 
                               Tuya is also
                                used to <strong>ate automations and scene routines. <br><br></strong>
                                They can work:
                        ...
                        <div class=\"col-10 my-auto\">
                            <p class=\"text1 my-auto py-3\">
                                <strong>Together-with</strong> or under existing smart <strong>home management
                                    platforms</strong> (Google, Amazon,
                                Samsung, Smartlife)
                            </p>
                        </div>
                        <div class=\"col-2 my-auto\">
                                ...
                                <div class=\"col-9\">
                                    <p class=\"text1\">
                                        Corridors and bathrooms rooms are only dimly lit unless <strong>sensors detect
                                            movement</strong>.
                                        During the day they set themselves to a default mode. In unused rooms they go
                                        back to power saving, decoration or off mode.
                                    </p>
                                </div>
                            </div>
                            <div class=\"row align-items-center \">
                                ...
                                <div class=\"col-9\">
                                    <p class=\"text1\">
                                        Kinetic switches can be <strong>moved dynamically</strong> and there is no need
                                        for rewiring
                                        new batteries painting or any other work to achieve this.
                                    </p>
                                </div>
                            </div>
                            <div class=\"row align-items-center\">
 ...
 <strong>changes lighting scenes </strong> or starts automations. For instance, it can let the blinds down, make lighting go to dim modeetc.
                    ...
                    <div class=\" col-10 mr-auto\">
                        <div class=\"container-fluid mr-0 text-center\">
                            ...
                            <div class=\"row align-items-center\">
                                ...
                                <div class=\"col-9\">
                                    <p class=\"text1\">
                                        ...
                                        <strong> do
                                            nothing if there was rainfall </strong> the last day. It can also be
                                        controlled by the
                                        user on their phone.
                                    </p>
                                </div>
                            ...
                            <div class=\"row align-items-center\">
                                ...
                                <div class=\"col-9\">
                                    <p class=\"text1\">
                                        They can be managed using a motorized ball valve or a vax water valve
                                        controller.
                                    </p>
                                </div>
                            </div>
                    ...
                    <div class=\" col-10 mr-auto \">
                        <div class=\"container-fluid mr-0 text-center\">
                            ...
                            <div class=\"row align-items-center\">
                                ...
                                <div class=\"col-9\">
                                    <p class=\"text1\">
                                        The sensors in the house can be used to <strong> track intruders</strong>, so
                                        the user can exit the building if needed.
                                    </p>
                                </div>
                            </div>
                            <div class=\"row align-items-center\">
                                ...
                                <div class=\"col-9\">
                                    <p class=\"text1\">
                                        The <strong> alarm hub can be programed with the users phone</strong> to get
                                        armed and disarmed automatically based on time
                                        (working hours of a business for instance) or the users phone location so that
                                ...
                                <div class=\"col-9\">
                                    <p class=\"text1\">
                                        KRC-200 series controllers (actuators) <strong>can be built into the wall
                                            socket</strong> behind
                                        the light switches. Connecting their inputs
                                        to the switch allows the user to control them with the mechanical switch while
                                        still working through the Tuya app and the kinetic switches
                                    </p>
                                </div>
                            </div>
                            <div class=\"row align-items-center\">
                                ...
                                <div class=\"col-9\">
                                    <p class=\"text1\">
                                        The system <strong>can be expanded with kinetic switches</strong> if needed.
                                        They can be easily
                                        moved and even mounted on glass if need
                                    </p>
                                </div>
                            </div>
                            <div class=\"row align-items-center\">
        ...
        <div id=\"right\" class=\"ms-right\">
            ...
            <section class=\" section2-r\">
                ...
                <div class=\" mr-3\">
                    <div class=\"col-sm-11 h-auto m-auto\">
                        <p class=\"text1\">The best feature of an intelligent building is that all smart components are in
                            constant
                            communication with each other. This allows them to <strong> detect many environmental
                                factors and
                                adapt to them instantly.</strong>
                            This is called automation and is the main component of an intelligent building.
                        </p>
                    ...
                    <div class=\"col-10 my-auto\">
                        <p class=\"text1 my-auto py-3\">
                            <strong>Detection: </strong>An event is registered by a sensor (water/smoke/movement detected or a timer)
Than the system triggers the related components of the smart house
                        </p>
                    </div>
                    <div class=\"col-2 my-auto\">
                    ...
                    <div class=\"col-10 my-auto\">
                        <p class=\"text1 my-auto py-3\">
                            <strong>Notification:</strong> The user is (optionally) notified that the task has been
                            finished.
                        </p>
                    </div>
                </div>
            ...
            <section class=\" section6-r\">
                <div class=\" align-items-center mb-5\">
                    ...
                    <div class=\"row \">
                        <div class=\"col-sm-11 h-auto m-auto\">
                            <p class=\"text1\">
                                Unlike traditional wired and battery powered switches. Kinetic switches <strong> can be placed on any surface</strong> and are <strong>self-powered</strong>, so they do not require
                                additional power sources (wiring or
                                battery). When the user presses a kinetic switch the movement of the switch generates
                                energy that powers the built-in radio relay. This sends out a signal to the receiver and
                                the task associated whit the switch is started. <br>
                                <strong>Kinetic door sensors work on the same principle .</strong> <br>
                                The speed or time of the button press doesn't affect the system.

                                <br> Their main advantages are: <br>
                            </p>
                        </div>
                        <div class=\"col-2 my-auto\">
                        ...
                        <div class=\"col-10 my-auto\">
                            <p class=\"text1 my-auto py-3\">
                                Can be used under wet conditions or outside thanks to It's water resistance (IP67
                                rating).
                            </p>
                        </div>
                    </div>
                    ...
                    <div class=\" col-10 ml-auto\">
                        <div class=\"container-fluid mr-0 text-center \">
                            <div class=\"row align-items-center\">
                                <div class=\"col-9\">
                                    <p class=\"text1\">
                                        The system slightly raises the blinds so that sunlight can get into the room. It
                                        keeps raising them slowly so the <strong>user can be woken up by mild sunlight</strong>. During
                                        winter the same can also be achieved with the lights in the room.
                                    </p>
                                </div>
                                <div class=\"col-3 avatar\">
                                    <img src=\" ./resources/img/switch.png\" class=\"w-100\" alt=\"\">
                            ...
                            <div class=\"row align-items-center\">
                                <div class=\"col-9\">
                                    <p class=\"text1\">
                                        <strong>Climate control</strong> would adjust the air conditioning or
                                        heating before the user
                                        woke up.
                                    </p>
                                </div>
                                <div class=\"col-3 avatar\">
                    ...
                    <div class=\" col-10 ml-auto\">
                        <div class=\"container-fluid mr-0 text-center\">
                                ...
                                <div class=\"col-9\">
                                    <p class=\"text1\">
                                        By placing thermostats in multiple rooms, the user can <strong>improve energy
                                            efficiency
                                            up to 30-45%</strong> with automations. The system can also integrate air
                                        conditioning as
                                        well.
                                    </p>
                                </div>
                            ...
                            <div class=\"row align-items-center\">
                                <div class=\"col-9\">
                                    <p class=\"text1\">
                                        When <strong>the user leaves</strong> the building and arms the security system,
                                        all the <strong>thermostats switch into low power mode</strong> . And if needed
                                        it
                                        can be turned back on through the Tuya app .
                                    </p>
                                </div>
                                <div class=\"col-3 avatar\">
                                    <img src=\" ./resources/img/panel.png\" class=\"w-100\" alt=\"\">
                            ...
                            <div class=\"row align-items-center\">
                                <div class=\"col-9\">
                                    <p class=\"text1\">
                                        <strong>Existing radiator systems can also be upgraded</strong> using radiator
                                        mounted
                                        ZigBee thermostats. They don’t require any wiring and can be shut off when an
                    ...
                    <div class=\" col-10 ml-auto\">
                        <div class=\"container-fluid mr-0 text-center\">
                            <div class=\"row \">
                                <div class=\"col-9\">
                                    <p class=\"text1\">
                                        Multifunctional gas sensors can be used to detect various kinds of gas leaks
                                        dependent
                                        on It's positioning (close to the floor or the celling). <strong> The device can
                                            detect
                                            6-8% combustible
                            ...
                            <div class=\"row align-items-center\">
                                <div class=\"col-9\">
                                    <p class=\"text1\">
                                        Videosec <strong> smoke detectors can notify the user in the same way</strong>
                                        as well, if they
                            ...
                            <div class=\"row align-items-center\">
                                <div class=\"col-9\">
                                    <p class=\"text1\">
                                        To prevent serious tragedy, use of smoke and gas sensors are crucial in any
                                        modern home. Based on their signals a venting system can be activated and an
                                        impulse controlled <strong> gas valve can block the main gas pipe.</strong>
                                        While informing the
                                        user.
                                    </p>
                                </div>
                    ...
                    <div class=\" col-10 ml-auto\">
                        <div class=\"container-fluid mr-0 text-center\">
                            <div class=\"row align-items-center\">
                                <div class=\"col-9\">
                                    <p class=\"text1\">
                                        A camera with an alarm output can be set up to <strong>detect (selectively) people or vehicles</strong>, and send trigger signals to various automations. (for instance people walking nearby)
                            ...
                            <div class=\"row align-items-center\">
                                <div class=\"col-9\">
                                    <p class=\"text1\">
                                        The signal can be received by a <strong> Tuya controller (actuator)</strong>
                                        that can <strong>execute multiple automations</strong> (for example open gates and turn of sprinklers etc.)
                                    </p>
                                </div>
                                <div class=\"col-3 avatar\">
                                    <img src=\" ./resources/img/kapunyito.png\" class=\"w-100\" alt=\"\">
                    ...
                    <div class=\" col-10 ml-auto mb-auto\">
                        <div class=\"container-fluid mr-0 text-center\">
                            <div class=\"row \">
                                <div class=\"col-9\">
                                    <p class=\"text1\">
                                        To <strong>prevent freezing in vacation houses</strong> during the winter
                                        connecting an electric
                                        heater to a Videosec wall plug with a built in thermostat is recommended.
                                    </p>
                                </div>
                                <div class=\"col-3 avatar\">
                                ...
                                <div class=\"col-9\">
                                    <p class=\"text1\">
                                        If a door or window was left open the system turns the heating off and notifies
                                        the user. <strong>Preventing energy waste</strong>.
                                    </p>
                                </div>
                                <div class=\"col-3 avatar\">
                                    <img src=\" ./resources/img/door-sensor.png\" class=\"w-100\" alt=\"\">
            ...
            <div class=\"\">
                <div>
                    ...
                    <div class=\"col-12\" style=\"padding-top:6vh\">
                        <p class=\"m-text1\"> An intelligent building is capable of more than just direct user control.
                            The building instantly <strong>completes tasks by itself</strong> if the correct
                            requirements are
                            met.
                        </p>
        ...
        <section class=\"section2\" id=\"m-automation\">
            <div class=\"\">
                <div>
                    ...
                    <div class=\"col-12\">
                        <p class=\"m-text1\">
                            The best feature of an intelligent building is that all smart components are in
                            constant
                            communication with each other. This allows them to <strong> detect many environmental
                                factors and
                                adapt to them instantly.</strong>
                            This is called automation and is the virtual essence of an intelligent building.
                            <br><br>
                    ...
                    <div class=\"col-9 p-0 mb-0 mt-5\">
                        <p class=\"align-text-bottom\">
                            When the security system is connected to an intelligent building all <strong> smart
                                ...
                                become a part of it </strong> (door/windows sensors, light switches, power usage
                            meters,
                            thermostats, water or gas sensors). This greatly detection accuracy
